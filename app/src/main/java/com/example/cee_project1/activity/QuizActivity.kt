...
class QuizActivity : AppCompatActivity() {
    ...
    private fun initData() {
        ...
        var term1= Term(1,"Economy_basic","생산","사람들에게 필요한 무언가를 만들어 내는 일을 말합니다.\n" +
                "        사람들에게 필요한 무언가는 재화(상품)와 용역(서비스)을 말합니다.",null,"예를 들어, 농부가 곡식을 키우는 일, 공장에서 물건을 만드는 일은 생산입니다.\n" +
                "            또한 병원에서의 의사의 치료 행위, 아르바이트도 예가 될 수 있습니다.",false,null)
        var term2= Term(2,"Economy_basic","분배","기업이 생산활동에 기여한 대가를 시장가격으로 보상해주는 것입니다." , null,"  예금이자를 받은 것, 주식에 투자하여 배당금을 받은 것이 있습니다.\n" +
                "            여기서 주식 배당금이란 기업이 영업활동을 잘해서 이익이 남게 되면 그 회사 주식을 보유한 주주들에게 소유 지분에 따라 이윤을 분배하는 것입니다.",false,null)
        var term3= Term(3,"Economy_basic","소비","만족을 얻으려고 생활에 필요한 재화나 서비스를 구매 또는 사용하는 행위" , null," 컴퓨터 게임 프로그램을 산 것은 소비이지만,\n" +
        ...
        var quiz1=Quiz(term1,"아르바이트는 생산의 예이다",true,0)
        var quiz2=Quiz(term2,"예금 이자를 받은 것은 생산의 예이다",false,0)
        var quiz3=Quiz(term3,"유튜브 동영상을 만드릭 위해서 편집 프로그램을 산 것은 소비이다",false,0)
